                        ...
                        <table> 
                             @foreach(empresa->pontocoletas as $pontocoleta)
                                    <tr>
                                        ...
                                        <td class="td">{{$pontocoleta->status}}</td>
                                        <td>{{$pontocoleta->clatitude}}</td>
                                        <td>{{$pontocoleta->longitude}}</td>
                                        <td><form action="/apagar-empresa/{{$pontocoleta>id}}" method= "post">
                                        ...
                                        <td>
                                            <a href="/editar-pontocoleta/{{$pontocoleta->id}}" method="GET" class="btn-function"> editar</a>
                                        </td>
